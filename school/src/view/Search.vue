                        ...
                        <el-row>
                            <el-col :span="15">
                                <el-form-item label="搜索内容">
                                    <el-input v-model="formData.keyword" placeholder="请输入搜索内容"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="5">
                                        ...
                                        <div class="st2">
                                            <div class="st21">
                                                <div class="st211" v-html="el.con"
                                                     :style="sortName!='notice'?'margin-right:20px':''"></div>
                                                <div class="st212">
                                                        <span class="date">
    ...
    export default {
        ...
        methods:{
            ...
            onSubmit(){
                ...
                this.listTitle = titles[this.sortName];
                const params = {params:this.formData}
                this.$axios.get('getSearchZong', params).then(total => {
                    this.total = total;
                })
                this.listData();
            },
            listData(){
                ...
                this.$axios.get('getSearchMessages',params).then(arr=>{
                    arr = arr.map(el => {
                        if (sortName != 'video' && sortName != 'notice' && sortName != 'image') {
                        ...
                        if (sortName === 'video' || sortName === 'image') {
                            sortName === 'video'? el.src=this.Url + 'video/' + el.src:el.src=this.Url + 'photoes/' + el.src;
